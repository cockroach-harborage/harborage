...
- **Phishing-resistant MFA on all privileged surfaces.** Passkey / hardware FIDO2 only — **no SMS OTP** anywhere. Prefer Access Independent MFA to force a hardware key on the console app.
